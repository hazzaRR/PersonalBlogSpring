...
INSERT INTO users (user_id, username, password, firstname) VALUES (0, 'admin', '$2a$10$EwkR./m0nafR6GhAOErcAOawGqG.4nYbVxgZkJbWqhEJHvbP6nzZm', 'admin') ON CONFLICT DO NOTHING;
